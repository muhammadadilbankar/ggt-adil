...
export default function AgriculturalTechnologies() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-center">
        <h1 className="text-4xl font-bold mb-4">Agricultural Technologies</h1>
        <p className="text-lg text-gray-700">This is the Agricultural Technologies page. Add your content here.</p>
      </main>
      <Footer />
      <style>{`
